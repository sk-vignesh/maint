  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-6 md:p-8 lg:p-10">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div><h1 className="text-2xl font-bold tracking-tight md:text-3xl">Fuel Receipts</h1><p className="mt-1 text-sm text-muted-foreground">VAT-recoverable fuel receipt management and approval workflow.</p></div>
