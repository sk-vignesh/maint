# Toll Import Log API Documentation
...
**`GET /expense-reports/toll-import-logs`**

Returns a paginated, combined list of toll import log entries for the authenticated company. The response merges two sources:

- **`spreadsheet`** logs — from Excel/CSV toll report imports (`files` + `import_logs` tables, `type = 'toll_report_import'`)
- **`receipt`** logs — from ZIP-based toll receipt image imports (`expense_receipt_image_logs` table, `report_type = 'toll'`)
...
```
GET /api/v1/expense-reports/toll-import-logs?page=1&sort=-log_date
GET /api/v1/expense-reports/toll-import-logs?log_type=receipt&page=1&limit=20
GET /api/v1/expense-reports/toll-import-logs?log_type=spreadsheet&page=1
```
    ...
    "data": [
        {
            ...
            "filename": "toll_report_march.xlsx",
            "file_url": "https://storage.example.com/uploads/toll_report_march.xlsx",
            ...
            "status": "COMPLETED",
            "error_log_url": "https://storage.example.com/error-logs/toll_errors.txt",
            "total_records": 120,
            "success_records": 118,
            "failed_records": 2,
            "skipped_records": 0
        },
        {
            ...
            "file_url": "https://storage.example.com/uploads/toll_zip_extracted/receipt_001.jpg",
...
{
    "status": "error",
    "message": "Failed to list toll import logs",
    "error": "..."
}
```
